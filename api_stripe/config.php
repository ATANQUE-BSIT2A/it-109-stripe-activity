...
// This file holds all our settings (Stripe keys, products list, etc.)
// ============================================================================

return [
    // Stripe API credentials (TEST MODE ONLY - starts with sk_test_)
    // Never share your live secret key publicly!
    'stripe_secret_key' => '',
    
    // Which version of Stripe's API we're using
    'stripe_api_version' => '2026-02-25.clover',
    
    // ========================================================================
    // PRODUCTS LIST - All items we're selling
    // ========================================================================
    'products' => [
        // Product 1: M2R2 Cap
        [
            ...
            "description" => 'The piece that started it all. A six-panel washed canvas cap featuring an adjustable brass buckle closure, low-profile silhouette, and everyday comfort. Designed to complete any fit while carrying the M2R identity wherever you go.',
            'amount' => 18.00,
            'currency' => 'usd',
        ...
        [
            ...
            'name' => 'M2R2 "PeaceMaker" White Tee',
